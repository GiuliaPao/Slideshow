...
private slots:
    ...
    void test_forward();
    void test_back();
    void test_first_image_back();
    void test_last_image_forward();
...
{
    ms->goBack();
    QCOMPARE(ms->getCurrentImg(), 0);
}

void slideshow::test_first_image_back(){
    ms->goBack();
    QCOMPARE(ms->getCurrentImg(), 3);
}

void slideshow::test_last_image_forward(){
    ms->goForward();
    QCOMPARE(ms->getCurrentImg(), 0);
}
